...
const resolvers = {
  Query: {
    userByAge: (parent, {
      ...
      return _db__WEBPACK_IMPORTED_MODULE_0__["users"].find(user => user.age === age);
    },
